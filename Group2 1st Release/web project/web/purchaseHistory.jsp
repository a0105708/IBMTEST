...
<html>
		...
		<div class="pag-nav">
			<ul class="p-list">
				<li><a href="index.jsp">Home</a></li> 
                                <li class="act"><a href="order.jsp" class="cart-button"><h5>&nbsp;Shopping Cart</h5></a></li>
			</ul>
		</div>
		<div class="coats">
			<h3 class="c-head">View My Purchase History</h3>
                        <br>
		</div>
	...
	java.util.List<wss.PurchaseEntity> result = port.viewPurchaseHistory(accountId);
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-10 col-md-offset-1">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <%for(wss.PurchaseEntity o: result){
                                   int quantity = o.getQuantity();
                                   Long orderId = o.getOrderId();
                                   String date = o.getPurchasedDate().toString();                                                                                 
       
                            wss.OrderEntity orderE = port.viewOrderById(orderId);
                            String itemId = orderE.getItemId().toString();
