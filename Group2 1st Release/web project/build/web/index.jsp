					...
					<ul>
						<li>
							...
							<%if (session.getAttribute("userid")!=null){ %>
                                                        ...
                                                        <a href="viewAccount.jsp"><%out.print(request.getParameter("gmail"));%></a>
                                                        <%}else {%>
		   ...
		   <div class="col-md-4 right-grid">
				<div class="right-grid-top">
					...
					<div class="r-discount">
						...
						<h2>50%</h2>
						<p>OFF</p>
						<a href="products.jsp">shop now<i class="go"></i></a>
					</div>
					<div class="clearfix"></div>
				</div>
	  ...
	  <div class="clients">
		...
		<div class="transport-grid">
			<div class="col-md-4 shipping">
				...
				<p>Find eligible offers by looking for items with "FREE Shipping" listed on the product detail page.</p>
			</div>
			<div class="col-md-4 shipping">
				<h3><i class="correct-icon"></i>100 % Original</h3>
				<p>All products sold are brand new and genuine. Choose from an extensive range of products from different categories.</p>
			</div>
			<div class="col-md-4 return">
				<h3><i class="return-icon"></i>Free Return</h3>
				<p>You can return your order for a full refund on condition that returns must be in the state you received them, and in the original packaging. </p>
			</div>
			<div class="clearfix"></div>
		</div>
	  </div>
