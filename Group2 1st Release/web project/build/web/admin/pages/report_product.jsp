                                ...
                                <tbody>
                                    ...
                                    <%                                        try { //get list of all accounts
                                            ...
                                            for (int i = 0; i < result.size(); i++) {
                                                ...
                                                String name = result.get(i).getItemName();
                                                String itemId= result.get(i).getId().toString();
                                               ...
                                               out.println("<td>" + name + "</td>");
                                                ...
                                                out.println("</button> <li><a href=\"report_productReportList.jsp?itemId=" + itemId + "\">View</a></li>");
