<%-- 
    ...
    Created on : Apr 4, 2015, 10:23:36 PM
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel-heading">
                        General Report List 
                        <div class="botton5">
                            <form action="create_generalReport.jsp">
                                <input type="submit" value="Create General Report" class="botton100" >
                            </form>
                        ...
                        <table id="dataTableID" class="table table-bordered table-hover table-striped" >
                            ...
                            <tbody>
                                ...
                                <%                                        try { //get list of all accounts
                                        ...
                                        java.util.List<wss.ReportEntity> result = port.listReport("G");
