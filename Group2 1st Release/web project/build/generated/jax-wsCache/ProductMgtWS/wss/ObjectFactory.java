...
public class ObjectFactory {
    ...
    private final static QName _RemoveComment_QNAME = new QName("http://WSS/", "removeComment");
    ...
    private final static QName _CommentNotFoundException_QNAME = new QName("http://WSS/", "CommentNotFoundException");
    private final static QName _SearchProduct1_QNAME = new QName("http://WSS/", "searchProduct_1");
    private final static QName _RemoveCommentResponse_QNAME = new QName("http://WSS/", "removeCommentResponse");
    ...
    /**
     * Create an instance of {@link CommentNotFoundException }
     * 
     */
    public CommentNotFoundException createCommentNotFoundException() {
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WSS/", name = "removeComment")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link CommentNotFoundException }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://WSS/", name = "CommentNotFoundException")
    public JAXBElement<CommentNotFoundException> createCommentNotFoundException(CommentNotFoundException value) {
        return new JAXBElement<CommentNotFoundException>(_CommentNotFoundException_QNAME, CommentNotFoundException.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://WSS/", name = "removeCommentResponse")
