...
<body>
    ...
    %>
            <div class="grid_1_of_4 images_1_of_4">
					 <a href="single.jsp?id=<%out.print(item.getId());%>">
					  ...
					  <div class="button"><span><img src="images/cart.jpg" alt="" /><a href="single.jsp?id=<%out.print(item.getId());%>" class="cart-button">Add to Cart</a></span> </div>
	...
	out.println("No products so far.. Please contact administrator to add products....");
    }
    %>
    <%-- end web service invocation --%>
				<div class="clearfix"></div>
