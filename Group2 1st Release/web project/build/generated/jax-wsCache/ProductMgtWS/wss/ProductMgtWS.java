...
public interface ProductMgtWS {
     ...
     * @return
     *     returns boolean
     * @throws CommentNotFoundException_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "removeComment", targetNamespace = "http://WSS/", className = "wss.RemoveComment")
    @ResponseWrapper(localName = "removeCommentResponse", targetNamespace = "http://WSS/", className = "wss.RemoveCommentResponse")
    @Action(input = "http://WSS/ProductMgtWS/removeCommentRequest", output = "http://WSS/ProductMgtWS/removeCommentResponse", fault = {
        @FaultAction(className = CommentNotFoundException_Exception.class, value = "http://WSS/ProductMgtWS/removeComment/Fault/CommentNotFoundException")
    })
