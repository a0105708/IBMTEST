                                ...
                                <tbody>
                                    ...
                                    <%                                                try { //get list of all accounts
                                            ...
                                            for (int i = 0; i < result.size(); i++) {
                                                ...
                                                String name = result.get(i).getWineryName();
                                                String address = result.get(i).getWineryAddress();
                                                String contact = result.get(i).getWineryContact();
                                                String wineryId = result.get(i).getId().toString();
                                                int rowNum = i + 1;
                                                ...
                                                out.println("<li><a href=\"winery_update.jsp?wineryId=" + wineryId + "\">Edit</a></li>");
                                                out.println("<li><a href=\"postpages/productMgt/deleteWineryPost.jsp?wineryId=" + wineryId + "\">Delete</a></li>");
